...
<div className="engInfuCont">
 ...
 <div className={`custom-checkbox ${isChecked ? 'checked' : ''}`} onClick={handleCheckboxChange}>
  ...
  <path d="M16.8809 0.5L15.0638 2.39614L7.74259 9.71736L5.60942 7.66321L3.71328 5.76706L0 9.48034L1.89614 11.3765L5.84644 15.3268L7.66358 17.2229L9.55972 15.3268L18.7771 6.10942L20.6732 4.21328L16.8809 0.5Z" fill="#FF8080"/>
</svg>
    </div>

    <p className="engText">Automatically ‘Like’ every post with more than </p>
 ...
 <div className={`custom-checkbox ${isChecked1 ? 'checked' : ''}`} onClick={handleCheckboxChange1}>
      {/* Your SVG code goes here */}
     <svg xmlns="http://www.w3.org/2000/svg" width="21" height="19" viewBox="0 0 21 19" fill="none">
  <path d="M16.8809 0.5L15.0638 2.39614L7.74259 9.71736L5.60942 7.66321L3.71328 5.76706L0 9.48034L1.89614 11.3765L5.84644 15.3268L7.66358 17.2229L9.55972 15.3268L18.7771 6.10942L20.6732 4.21328L16.8809 0.5Z" fill="#FF8080"/>
</svg>
    ...
    <p className="engText">Automatically comment on every post with more than  </p>
 ...
 <div className={`custom-checkbox ${isChecked2 ? 'checked' : ''}`} onClick={handleCheckboxChange2}>
      {/* Your SVG code goes here */}
     <svg xmlns="http://www.w3.org/2000/svg" width="21" height="19" viewBox="0 0 21 19" fill="none">
  <path d="M16.8809 0.5L15.0638 2.39614L7.74259 9.71736L5.60942 7.66321L3.71328 5.76706L0 9.48034L1.89614 11.3765L5.84644 15.3268L7.66358 17.2229L9.55972 15.3268L18.7771 6.10942L20.6732 4.21328L16.8809 0.5Z" fill="#FF8080"/>
</svg>
    ...
    <p className="engText">Automatically repost every post with more than </p>
